...
const pageLoad = () => {
  const trigger = document.querySelector(".home_load-trigger");
  const preloadTrigger = document.querySelector(".home_preloader-trigger");
  const loader = document.querySelector(".page_load");
  const preLoad = document.querySelector(".pre-loader");

  // Check if the "first_load" flag is set in the session storage
